...
// footprint widths
#define FOOTPRINT_ZOMBIE 9
#define FOOTPRINT_BABYPENGUIN 5
#define FOOTPRINT_PENGUIN 7
//#define FOOTPRINT_GREY
...
public:
	...
	virtual int FootPrintDecal( void ){ int fpdid = decalsystem->GetDecalIndexForName( "FootPrintHuman" ); return fpdid; };
	virtual void SnowFootPrint( bool IsLeft );
...
protected:
	...
	int		m_fIsTorso;			// is this is a half-zombie? ICEMOD we chaged this to an int
	bool	m_fIsHeadless;		// is this zombie headless
	// FOOTPRINT ENEMY HALF WIDTH
	int		m_fModelHalfWidth;
