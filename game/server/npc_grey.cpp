...
#ifndef HL2_EPISODIC
	void CheckFlinches() {} // Grey has custom flinch code
#endif // HL2_EPISODIC
...
void CGrey::Precache( void )
{
	...
	PrecacheScriptSound( "Grey.AttackHit" );
	PrecacheScriptSound( "Grey.AttackMiss" );
	PrecacheScriptSound( "Grey.Pain" );
	PrecacheScriptSound( "Grey.Die" );
	PrecacheScriptSound( "Grey.Alert" );
	PrecacheScriptSound( "Grey.Idle" );
	PrecacheScriptSound( "Grey.Attack" );

	PrecacheScriptSound( "NPC_BaseGrey.Moan1" );
	PrecacheScriptSound( "NPC_BaseGrey.Moan2" );
	PrecacheScriptSound( "NPC_BaseGrey.Moan3" );
	PrecacheScriptSound( "NPC_BaseGrey.Moan4" );
...
//-----------------------------------------------------------------------------
void CGrey::FootstepSound( bool fRightFoot )
{
	if( fRightFoot )
	{
...
//-----------------------------------------------------------------------------
void CGrey::FootscuffSound( bool fRightFoot )
{
	if( fRightFoot )
	{
...
//-----------------------------------------------------------------------------
void CGrey::AttackHitSound( void )
{
	EmitSound( "Grey.AttackHit" );
}

//-----------------------------------------------------------------------------
// Purpose: Play a random attack miss sound
//-----------------------------------------------------------------------------
void CGrey::AttackMissSound( void )
{
	// Play a random attack miss sound
	EmitSound( "Grey.AttackMiss" );
}

//-----------------------------------------------------------------------------
// Purpose: 
//-----------------------------------------------------------------------------
void CGrey::PainSound( const CTakeDamageInfo &info )
{
...
//-----------------------------------------------------------------------------
//-----------------------------------------------------------------------------
void CGrey::DeathSound( const CTakeDamageInfo &info ) 
{
	EmitSound( "Grey.Die" );
}
...
// Purpose: 
//-----------------------------------------------------------------------------
void CGrey::AlertSound( void )
{
	EmitSound( "Grey.Alert" );
...
//-----------------------------------------------------------------------------
// Purpose: Returns a moan sound for this class of grey.
//-----------------------------------------------------------------------------
const char *CGrey::GetMoanSound( int nSound )
{
...
//-----------------------------------------------------------------------------
void CGrey::AttackSound( void )
{
	EmitSound( "Grey.Attack" );
}
...
//---------------------------------------------------------
void CGrey::MoanSound( envelopePoint_t *pEnvelope, int iEnvelopeSize )
{
	if( IsOnFire() )
	{
