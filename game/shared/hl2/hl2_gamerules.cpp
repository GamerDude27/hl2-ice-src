...
//ConVar	sk_plr_dmg_atomsmasher		( "sk_plr_dmg_atomsmasher","0", FCVAR_REPLICATED);
//ConVar	sk_npc_dmg_atomsmasher		( "sk_npc_dmg_atomsmasher","0", FCVAR_REPLICATED);
//ConVar	sk_max_atomsmasher			( "sk_max_atomsmasher","0", FCVAR_REPLICATED);

ConVar	sk_max_mobileturret		( "sk_max_mobileturret","0", FCVAR_REPLICATED);
...
CAmmoDef *GetAmmoDef()
{
	...
	if ( !bInitted )
	{
		...
		def.AddAmmoType("Pistol",			DMG_BULLET,					TRACER_LINE_AND_WHIZ,	"sk_plr_dmg_357",			"sk_npc_dmg_357",			"sk_max_357",			BULLET_IMPULSE(800, 5000), 0 );
		//def.AddAmmoType("Pistol",			DMG_BULLET,					TRACER_LINE_AND_WHIZ,	"sk_plr_dmg_pistol",		"sk_npc_dmg_pistol",		"sk_max_pistol",		BULLET_IMPULSE(800, 5000), 0 );
		...
		//ICE
		def.AddAmmoType("AtomSmasher",		DMG_SHOCK,					TRACER_NONE,			0,	0,	260, 0, 0 ); //"sk_plr_dmg_atomsmasher",		"sk_npc_dmg_atomsmasher",		"sk_max_atomsmasher",		BULLET_IMPULSE(200, 1225), 0 );
		def.AddAmmoType("MobileTurretAmmo",	DMG_BULLET,					TRACER_NONE,			0, 0, 3, 0, 0 ); //0, 0, "sk_max_mobileturret", 0, 0
