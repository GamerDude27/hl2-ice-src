...
#include "gib.h" // ICEMOD, for combine gibs
...
void CNPC_CombineS::Precache()
{
	...
	// ICEMOD if the model is one of our wrecked combine, we set up this Interger
	// used to select the right gib models for if our combine is blown up
	// 0 = no gibs
	// 1 = combine_soldier_prisonguard_v1.mdl
	// 2 = combine_soldier_prisonguard_v2.mdl
	// 3 = combine_soldier_prisonguard_v3.mdl
	if( !Q_stricmp( pModelName, "models/combine_soldier_prisonguard_v1.mdl" ) )
	{
		m_iGibModels = 1;
	}else if( !Q_stricmp( pModelName, "models/combine_soldier_prisonguard_v2.mdl" ) )
	{
		m_iGibModels = 2;
	}else if( !Q_stricmp( pModelName, "models/combine_soldier_prisonguard_v3.mdl" ) )
	{
		m_iGibModels = 3;
	}else
	{
	...
	PrecacheModel( "models/gibs/combine/v1_torso_rleg.mdl" );
	PrecacheModel( "models/gibs/combine/torso_rleg.mdl" );
	PrecacheModel( "models/gibs/combine/v23_torso.mdl" );

	PrecacheModel( "models/gibs/combine/v1_head.mdl" );
	PrecacheModel( "models/gibs/combine/v23_head.mdl" );

	PrecacheModel( "models/gibs/combine/v1_rarm.mdl" );
	PrecacheModel( "models/gibs/combine/v2_lleg.mdl" );
	PrecacheModel( "models/gibs/combine/v3_rleg.mdl" );

	PrecacheModel( "models/gibs/combine/chunk1.mdl" );
	PrecacheModel( "models/gibs/combine/chunk1b.mdl" );
	PrecacheModel( "models/gibs/combine/chunk2.mdl" );
...
void CNPC_CombineS::Event_Killed( const CTakeDamageInfo &info )
{
	...
	// check if we were blown up, if so gib
	if( info.GetDamageType() & ( DMG_BLAST ) )
	{
		if(m_iGibModels > 0)
		{
			int tempRanInt = RandomInt(0,2);
			if(m_iGibModels == 1) // variation 1 of the wrecked combine
			{
				if(tempRanInt == 0)
				{
					// no torso, just lots of chunks
					SetModel( "models/gibs/combine/v1_torso_rleg.mdl" );
					CGib::SpawnSpecificGibs( this, 1, 750, 1500, "models/gibs/combine/v1_rarm.mdl", 5 );
					CGib::SpawnSpecificGibs( this, 1, 750, 1500, "models/gibs/combine/chunk1.mdl", 5 );
					CGib::SpawnSpecificGibs( this, 1, 750, 1500, "models/gibs/combine/chunk1.mdl", 5 );
					CGib::SpawnSpecificGibs( this, 1, 750, 1500, "models/gibs/combine/chunk1b.mdl", 5 );
					CGib::SpawnSpecificGibs( this, 1, 750, 1500, "models/gibs/combine/chunk1b.mdl", 5 );
					CGib::SpawnSpecificGibs( this, 1, 750, 1500, "models/gibs/combine/chunk1b.mdl", 5 );
					CGib::SpawnSpecificGibs( this, 1, 750, 1500, "models/gibs/combine/chunk2.mdl", 5 );
					CGib::SpawnSpecificGibs( this, 1, 750, 1500, "models/gibs/combine/chunk2.mdl", 5 );
					CGib::SpawnSpecificGibs( this, 1, 750, 1500, "models/gibs/combine/chunk2.mdl", 5 );
				}else if(tempRanInt == 1)
				{
					// torso
					SetModel( "models/gibs/combine/v1_torso_rleg.mdl" );
					CGib::SpawnSpecificGibs( this, 1, 750, 1500, "models/gibs/combine/v1_head.mdl", 5 );
					CGib::SpawnSpecificGibs( this, 1, 750, 1500, "models/gibs/combine/chunk1.mdl", 5 );
					CGib::SpawnSpecificGibs( this, 1, 750, 1500, "models/gibs/combine/chunk1b.mdl", 5 );
					CGib::SpawnSpecificGibs( this, 1, 750, 1500, "models/gibs/combine/v1_rarm.mdl", 5 );
					CGib::SpawnSpecificGibs( this, 1, 750, 1500, "models/gibs/combine/chunk2.mdl", 5 );
					CGib::SpawnSpecificGibs( this, 1, 750, 1500, "models/gibs/combine/chunk2.mdl", 5 );
				}else if(tempRanInt == 2)
				{
					// torso with a leg attached
					SetModel( "models/gibs/combine/torso_rleg.mdl" );
					CGib::SpawnSpecificGibs( this, 1, 750, 1500, "models/gibs/combine/v1_rarm.mdl", 5 );
					CGib::SpawnSpecificGibs( this, 1, 750, 1500, "models/gibs/combine/chunk1.mdl", 5 );
					CGib::SpawnSpecificGibs( this, 1, 750, 1500, "models/gibs/combine/chunk1b.mdl", 5 );
					CGib::SpawnSpecificGibs( this, 1, 750, 1500, "models/gibs/combine/chunk2.mdl", 5 );
			...
			if(m_iGibModels == 2) // variation 2 of the wrecked combine
			{
				if(tempRanInt == 0)
				{
					SetModel( "models/gibs/combine/torso_rleg.mdl" );
					CGib::SpawnSpecificGibs( this, 1, 750, 1500, "models/gibs/combine/chunk1.mdl", 5 );
					CGib::SpawnSpecificGibs( this, 1, 750, 1500, "models/gibs/combine/chunk1.mdl", 5 );
					CGib::SpawnSpecificGibs( this, 1, 750, 1500, "models/gibs/combine/v2_lleg.mdl", 5 );
					CGib::SpawnSpecificGibs( this, 1, 750, 1500, "models/gibs/combine/v23_head.mdl", 5 );
					CGib::SpawnSpecificGibs( this, 1, 750, 1500, "models/gibs/combine/chunk1b.mdl", 5 );
					CGib::SpawnSpecificGibs( this, 1, 750, 1500, "models/gibs/combine/chunk1b.mdl", 5 );
					CGib::SpawnSpecificGibs( this, 1, 750, 1500, "models/gibs/combine/chunk2.mdl", 5 );
					CGib::SpawnSpecificGibs( this, 1, 750, 1500, "models/gibs/combine/chunk2.mdl", 5 );
				...
				{
					SetModel( "models/gibs/combine/v23_torso.mdl" );
					CGib::SpawnSpecificGibs( this, 1, 750, 1500, "models/gibs/combine/chunk1.mdl", 5 );
					CGib::SpawnSpecificGibs( this, 1, 750, 1500, "models/gibs/combine/chunk1.mdl", 5 );
					CGib::SpawnSpecificGibs( this, 1, 750, 1500, "models/gibs/combine/chunk1b.mdl", 5 );
					CGib::SpawnSpecificGibs( this, 1, 750, 1500, "models/gibs/combine/chunk1b.mdl", 5 );
			...
			if(m_iGibModels == 3) // variation 3 of the wrecked combine
			{
				if(tempRanInt == 0)
				{
					SetModel( "models/gibs/combine/v23_torso.mdl" );
					...
					CGib::SpawnSpecificGibs( this, 1, 750, 1500, "models/gibs/combine/chunk1b.mdl", 5 );
					CGib::SpawnSpecificGibs( this, 1, 750, 1500, "models/gibs/combine/chunk1b.mdl", 5 );
					CGib::SpawnSpecificGibs( this, 1, 750, 1500, "models/gibs/combine/v3_rleg.mdl", 5 );
					CGib::SpawnSpecificGibs( this, 1, 750, 1500, "models/gibs/combine/chunk2.mdl", 5 );
					CGib::SpawnSpecificGibs( this, 1, 750, 1500, "models/gibs/combine/chunk2.mdl", 5 );
				}else if(tempRanInt == 1)
				{
...
bool CNPC_CombineS::IsHeavyDamage( const CTakeDamageInfo &info )
{
	...
	// ICE MOD
	// pistol rounds are heavy damage
...
BEGIN_DATADESC( CNPC_CombineS )
	...
	DEFINE_FIELD( m_iGibModels, FIELD_INTEGER ),
