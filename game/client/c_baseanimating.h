...
public:
	...
	// snow Footprints for human Npc's like rebels and combine.
	virtual void SnowFootPrint( C_BaseAnimating *pEnt, bool IsLeft, bool isCombine );
	virtual int FootPrintDecal( void ){ int fpdid = decalsystem->GetDecalIndexForName( "FootPrintCombine" ); return fpdid; };
