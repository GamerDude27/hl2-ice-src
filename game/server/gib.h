...
public:
	...
	static	void AltSpawnSpecificGibs( CBaseEntity *pVictim, int nNumGibs, float fMaxVelocity, float fMinVelocity, const char* cModelName, int nBodyGroup, float flLifetime = 2);
...
public:
	...
	// ICEMOD voloxelican spit melts
	bool	m_bIsVoloxelican_Spit;
	bool	m_bVolDoOnce;
