...
BEGIN_RECV_TABLE_NOBASE( CPlayerLocalData, DT_Local )
	...
	// ICEMOD
	RecvPropInt		(RECVINFO(m_bWearingHelmet)),
	RecvPropInt		(RECVINFO(m_iHelmetDamageAlpha)),
	RecvPropInt		(RECVINFO(m_iHelmetBloodAlpha)),
	RecvPropInt		(RECVINFO(m_iHelmetBloodColor)),
...
BEGIN_PREDICTION_DATA_NO_BASE( CPlayerLocalData )
	...
	// ICEMOD
	DEFINE_PRED_FIELD( m_bWearingHelmet, FIELD_BOOLEAN, FTYPEDESC_INSENDTABLE ),
	DEFINE_PRED_FIELD( m_iHelmetDamageAlpha, FIELD_INTEGER, FTYPEDESC_INSENDTABLE ),
	DEFINE_PRED_FIELD( m_iHelmetBloodAlpha, FIELD_INTEGER, FTYPEDESC_INSENDTABLE ),
	DEFINE_PRED_FIELD( m_iHelmetBloodColor, FIELD_INTEGER, FTYPEDESC_INSENDTABLE ),
...
BEGIN_PREDICTION_DATA( C_BasePlayer )
	...
	// ICEMOD footprint
	DEFINE_FIELD( m_IsFootprintOnLeft, FIELD_BOOLEAN ),
...
bool C_BasePlayer::AudioStateIsUnderwater( Vector vecMainViewOrigin )
{
	...
	// HELEMT SOUND EFFECT LIKE WATER
	if(GetLocalPlayer()->IsHelmetEquipped())
	{
		return true;
	}
