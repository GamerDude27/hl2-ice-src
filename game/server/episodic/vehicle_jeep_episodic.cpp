...
LINK_ENTITY_TO_CLASS( prop_vehicle_lynx, CPropJeepEpisodic );
...
void CPropJeepEpisodic::CreateHazardLights( void )
{
	...
	for ( int i = 0; i < NUM_HAZARD_LIGHTS; i++ )
	{
		if ( m_hHazardLights[i] == NULL )
		{
			...
			{
				m_hHazardLights[i]->SetTransparency( kRenderWorldGlow, 255, 220, 220, 255, kRenderFxNoDissipation ); //kRenderWorldGlow, 255, 220, 40, 255, kRenderFxNoDissipation );
