...
ConVar	g_debug_icedog( "g_debug_icedog", "0" );
ConVar	sk_icedog_dmg_charge( "sk_icedog_dmg_charge", "0" );
ConVar	sk_icedog_dmg_shove( "sk_icedog_dmg_shove", "0" );

#if HL2_EPISODIC
// When enabled, add code to have the antlion bleed profusely as it is badly injured.
#define ICEDOG_BLOOD_EFFECTS 2
ConVar	g_icedog_hemorrhage( "g_icedog_hemorrhage", "1", FCVAR_NONE, "If 1, guard will emit a bleeding particle effect when wounded." );
#endif

// Spawnflags 
#define	SF_ICEDOG_SERVERSIDE_RAGDOLL	( 1 << 16 )
#define SF_ICEDOG_INSIDE_FOOTSTEPS	( 1 << 17 )

#define	ENVELOPE_CONTROLLER		(CSoundEnvelopeController::GetController())

#define	ICEDOG_MODEL		"models/dog/dog.mdl"
...
#define ICEDOG_MAX_OBJECTS				128
#define	ICEDOG_MIN_OBJECT_MASS			8
#define	ICEDOG_MAX_OBJECT_MASS			750
#define	ICEDOG_FARTHEST_PHYSICS_OBJECT	350
#define ICEDOG_OBJECTFINDING_FOV			DOT_45DEGREE // 1/sqrt(2)

//Melee definitions

#define	ICEDOG_MELEE1_RANGE		86.0f
#define	ICEDOG_MELEE1_CONE		0.7f

// Sight
#define	ICEDOG_FOV_NORMAL			-0.4f

#define	ICEDOG_CHARGE_MIN			86
#define	ICEDOG_CHARGE_MAX			5048 //2048

ConVar	sk_icedog_health( "sk_icedog_health", "0" );

int	g_interactionIcedogFoundPhysicsObject = 0;	// We're moving to a physics object to shove it, don't all choose the same object
int	g_interactionIcedogShovedPhysicsObject = 0;	// We've punted an object, it is now clear to be chosen by others
...
enum
{
	SCHED_ICEDOG_CHARGE = LAST_SHARED_SCHEDULE,
	SCHED_ICEDOG_CHARGE_CRASH,
	SCHED_ICEDOG_CHARGE_CANCEL,
	SCHED_ICEDOG_PHYSICS_ATTACK,
	SCHED_ICEDOG_PHYSICS_DAMAGE_HEAVY,
	SCHED_ICEDOG_CHARGE_TARGET,
	SCHED_ICEDOG_FIND_CHARGE_POSITION,
	SCHED_ICEDOG_MELEE_ATTACK1,
	SCHED_ICEDOG_PATROL_RUN,
	SCHED_ICEDOG_ROAR,
	SCHED_ICEDOG_CHASE_ENEMY_TOLERANCE,
	SCHED_FORCE_ICEDOG_PHYSICS_ATTACK,
	SCHED_ICEDOG_CANT_ATTACK,
	SCHED_ICEDOG_TAKE_COVER_FROM_ENEMY,
	SCHED_ICEDOG_CHASE_ENEMY
};
...
enum
{
	TASK_ICEDOG_CHARGE = LAST_SHARED_TASK,
	TASK_ICEDOG_GET_PATH_TO_PHYSOBJECT,
	TASK_ICEDOG_SHOVE_PHYSOBJECT,
	TASK_ICEDOG_SET_FLINCH_ACTIVITY,
	TASK_ICEDOG_GET_PATH_TO_CHARGE_POSITION,
	TASK_ICEDOG_GET_PATH_TO_NEAREST_NODE,
	TASK_ICEDOG_GET_CHASE_PATH_ENEMY_TOLERANCE,
	//TASK_ICEDOG_OPPORTUNITY_THROW,
	TASK_ICEDOG_FIND_PHYSOBJECT,
};
...
enum
{
	COND_ICEDOG_PHYSICS_TARGET = LAST_SHARED_CONDITION,
	COND_ICEDOG_PHYSICS_TARGET_INVALID,
	COND_ICEDOG_HAS_CHARGE_TARGET,
	COND_ICEDOG_CAN_CHARGE
};

enum
{	
	SQUAD_SLOT_ICEDOG_CHARGE = LAST_SHARED_SQUADSLOT,
};
...
Activity ACT_ICEDOG_SEARCH;
Activity ACT_ICEDOG_BARK;
Activity ACT_ICEDOG_SHOVE_PHYSOBJECT;
Activity ACT_ICEDOG_FLINCH_LIGHT;
Activity ACT_ICEDOG_ROAR;
Activity ACT_ICEDOG_RUN_HURT;

// Flinches
Activity ACT_ICEDOG_PHYSHIT_FR;
Activity ACT_ICEDOG_PHYSHIT_FL;
Activity ACT_ICEDOG_PHYSHIT_RR;
Activity ACT_ICEDOG_PHYSHIT_RL;

// Charge
Activity ACT_ICEDOG_CHARGE_START;
Activity ACT_ICEDOG_CHARGE_CANCEL;
Activity ACT_ICEDOG_CHARGE_RUN;
Activity ACT_ICEDOG_CHARGE_CRASH;
Activity ACT_ICEDOG_CHARGE_STOP;
Activity ACT_ICEDOG_CHARGE_HIT;
Activity ACT_ICEDOG_CHARGE_ANTICIPATION;

// Anim events
int AE_ICEDOG_CHARGE_HIT;
int AE_ICEDOG_SHOVE_PHYSOBJECT;
int AE_ICEDOG_SHOVE;
int AE_ICEDOG_FOOTSTEP_LIGHT;
int AE_ICEDOG_FOOTSTEP_HEAVY;
int AE_ICEDOG_VOICE_GROWL;
int AE_ICEDOG_VOICE_BARK;
int AE_ICEDOG_VOICE_PAIN;
int AE_ICEDOG_VOICE_SQUEEZE;
int AE_ICEDOG_VOICE_SCRATCH;
int AE_ICEDOG_VOICE_GRUNT;
int AE_ICEDOG_VOICE_ROAR;
int AE_ICEDOG_FOOTPRINT_LEFT;
int AE_ICEDOG_FOOTPRINT_RIGHT;
int AE_ICEDOG_FOOTPRINT_BACK;
...
// Purpose: 
//-----------------------------------------------------------------------------
class CNPC_Icedog : public CAI_BlendedNPC
{
public:
	DECLARE_CLASS( CNPC_Icedog, CAI_BlendedNPC );
	DECLARE_SERVERCLASS();
	DECLARE_DATADESC();
	...
	int FootPrintDecal( void ){ int fpdid = decalsystem->GetDecalIndexForName( "FootPrintIceDog" ); return fpdid; };
	...
	//---------------------------------
	class CNavigator : public CAI_ComponentWithOuter<CNPC_Icedog, CAI_Navigator>
	{
		typedef CAI_ComponentWithOuter<CNPC_Icedog, CAI_Navigator> BaseClass;
	public:
		CNavigator( CNPC_Icedog *pOuter )
			:	BaseClass( pOuter )
		{
		}
...
private:
	...
	void	UpdatePhysicsTarget( bool bPreferObjectsAlongTargetVector, float flRadius = ICEDOG_FARTHEST_PHYSICS_OBJECT );
...
//==================================================
// CNPC_Icedog::m_DataDesc
//==================================================

BEGIN_DATADESC( CNPC_Icedog )
...
envelopePoint_t envIcedogFastGrowl[] =
{
	{	1.0f, 1.0f,
		0.2f, 0.4f,
	},
...
//Bark 1 (Growl High)
envelopePoint_t envIcedogBark1[] =
{
	{	1.0f, 1.0f,
		0.1f, 0.2f,
	},
...
//Bark 2 (Confused)
envelopePoint_t envIcedogBark2[] =
{
	{	1.0f, 1.0f,
		0.1f, 0.2f,
	},
...
//Pain
envelopePoint_t envIcedogPain1[] =
{
	{	1.0f, 1.0f,
		0.1f, 0.2f,
	},
...
//Squeeze (High Growl)
envelopePoint_t envIcedogSqueeze[] =
{
	{	1.0f, 1.0f,
		0.1f, 0.2f,
	},
...
//Scratch (Low Growl)
envelopePoint_t envIcedogScratch[] =
{
	{	1.0f, 1.0f,
		0.4f, 0.6f,
	},
...
//Grunt
envelopePoint_t envIcedogGrunt[] =
{
	{	0.6f, 1.0f,
		0.1f, 0.2f,
	},
...
envelopePoint_t envIcedogGrunt2[] =
{
	{	0.2f, 0.4f,
		0.1f, 0.2f,
	},
...
//==============================================================================================
static impactentry_t iceDogLinearTable[] =
{
	{ 100*100,	10 },
	{ 250*250,	25 },
	{ 350*350,	50 },
...
static impactentry_t iceDogAngularTable[] =
{
	{  50* 50, 10 },
	{ 100*100, 25 },
	{ 150*150, 50 },
...
impactdamagetable_t gIcedogImpactDamageTable =
{
	iceDogLinearTable,
	iceDogAngularTable,
	
	ARRAYSIZE(iceDogLinearTable),
	ARRAYSIZE(iceDogAngularTable),
...
//-----------------------------------------------------------------------------
const impactdamagetable_t &CNPC_Icedog::GetPhysicsImpactDamageTable( void )
{
	return gIcedogImpactDamageTable;
}
...
CNPC_Icedog::CNPC_Icedog( void )
{

	m_iszPhysicsPropClass = AllocPooledString( "prop_physics" );
}

LINK_ENTITY_TO_CLASS( npc_icedog, CNPC_Icedog );

IMPLEMENT_SERVERCLASS_ST(CNPC_Icedog, DT_NPC_Icedog)
...
// Purpose: 
//-----------------------------------------------------------------------------
void CNPC_Icedog::UpdateOnRemove( void )
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CNPC_Icedog::Precache( void )
{
	PrecacheModel( ICEDOG_MODEL );

	PrecacheScriptSound( "NPC_AntlionGuard.Shove" );
	PrecacheScriptSound( "NPC_AntlionGuard.HitHard" );

	if ( HasSpawnFlags(SF_ICEDOG_INSIDE_FOOTSTEPS) )
	{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CNPC_Icedog::CreateGlow( CSprite **pSprite, const char *pAttachName )
{
	if ( pSprite == NULL )
		return;
...
// Purpose: 
//-----------------------------------------------------------------------------
void CNPC_Icedog::Spawn( void )
{
	Precache();

	SetModel( ICEDOG_MODEL );
	...
	m_iHealth = sk_icedog_health.GetFloat();
	m_iMaxHealth = m_iHealth;
	m_flFieldOfView	= ICEDOG_FOV_NORMAL;
...
// Purpose: 
//-----------------------------------------------------------------------------
void CNPC_Icedog::Activate( void )
{
	BaseClass::Activate();
	...
	while ( ( pObject = gEntList.FindEntityInSphere( pObject, WorldSpaceCenter(), 2500 ) ) != NULL )
	{
		...
		if( ( pPhysObj == NULL ) || ( pPhysObj->GetMass() > ICEDOG_MAX_OBJECT_MASS ) || ( pPhysObj->GetMass() < ICEDOG_MIN_OBJECT_MASS ) )
			continue;

		// Tell the AI sensing list that we want to consider this
		g_AI_SensedObjectsManager.AddEntity( pObject );

		if ( g_debug_icedog.GetInt() == 5 )
		{
...
//-----------------------------------------------------------------------------
int CNPC_Icedog::SelectUnreachableSchedule( void )
{
	...
	if ( pTarget )
	{
		...
		SetCondition( COND_ICEDOG_PHYSICS_TARGET );
		...
		if ( GetSquad() != NULL )
		{
			GetSquad()->BroadcastInteraction( g_interactionIcedogFoundPhysicsObject, (void *)((CBaseEntity *)m_hPhysicsTarget), this );
		}

		return SCHED_ICEDOG_PHYSICS_ATTACK;
	}
	...
	if ( HasCondition( COND_SEE_ENEMY ) )
	{
		...
		//{
			...
			//return SCHED_ICEDOG_TAKE_COVER_FROM_ENEMY;
		//}
	}
	...
	if ( flDistToEnemySqr > Square( 100*12 ) )
		return SCHED_ICEDOG_CHASE_ENEMY_TOLERANCE;
	...
	return SCHED_ICEDOG_CANT_ATTACK;
}

//-----------------------------------------------------------------------------
// Purpose: 
//-----------------------------------------------------------------------------
int CNPC_Icedog::SelectCombatSchedule( void )
{
	ClearHintGroup();
	...
	*/
	...
	//Physics target
	if ( HasCondition( COND_ICEDOG_PHYSICS_TARGET ) )
		return SCHED_ICEDOG_PHYSICS_ATTACK;

	// Charging
	if ( HasCondition( COND_ICEDOG_CAN_CHARGE ) )
	{
		// Don't let other squad members charge while we're doing it
		// OccupyStrategySlot( SQUAD_SLOT_ICEDOG_CHARGE );
		return SCHED_ICEDOG_CHARGE;
	}
...
//-----------------------------------------------------------------------------
bool CNPC_Icedog::ShouldCharge( const Vector &startPos, const Vector &endPos, bool useTime, bool bCheckForCancel )
{
	...
	if ( IsStrategySlotRangeOccupied( SQUAD_SLOT_ICEDOG_CHARGE, SQUAD_SLOT_ICEDOG_CHARGE ) )
		return false;
	...
	if ( !bCheckForCancel )
	{
		...
		if ( ( distance < ICEDOG_CHARGE_MIN ) || ( distance > ICEDOG_CHARGE_MAX ) )
			return false;
	}
	...
	if ( IsMoveBlocked( moveTrace ) )
	{
		...
		if ( UTIL_DistApprox( WorldSpaceCenter(), moveTrace.vEndPosition ) < ICEDOG_CHARGE_MIN )
			return false;
...
// Purpose: 
//-----------------------------------------------------------------------------
int CNPC_Icedog::SelectSchedule( void )
{

#if 0
	// Debug physics object finding
	if ( 0 ) //g_debug_icedog.GetInt() == 3 )
	{
		m_flPhysicsCheckTime = 0;
	...
	if ( HasCondition( COND_HEAVY_DAMAGE ) && m_flNextHeavyFlinchTime < gpGlobals->curtime )
	{
		...
		return SCHED_ICEDOG_PHYSICS_DAMAGE_HEAVY;
	}
	...
	{
		ClearCondition( COND_ICEDOG_HAS_CHARGE_TARGET );
		ClearHintGroup();
		...
		else
		{
			...
			if ( ShouldCharge( GetAbsOrigin(), GetEnemy()->GetAbsOrigin(), false, false ) == false )
				return SCHED_ICEDOG_FIND_CHARGE_POSITION;

			return SCHED_ICEDOG_CHARGE_TARGET;
		}
	}
...
// Purpose: 
//-----------------------------------------------------------------------------
int CNPC_Icedog::MeleeAttack1Conditions( float flDot, float flDist )
{
	...
	if ( IsCurSchedule( SCHED_ICEDOG_CHARGE ) )
		return 0;

	// Must be close enough
	if ( flDist > ICEDOG_MELEE1_RANGE )
		return COND_TOO_FAR_TO_ATTACK;
		

	// Must be within a viable cone
	if ( flDot < ICEDOG_MELEE1_CONE )
...
// Purpose: 
//-----------------------------------------------------------------------------
float CNPC_Icedog::MaxYawSpeed( void )
{
	Activity eActivity = GetActivity();

	// Stay still
	if (( eActivity == ACT_ICEDOG_SEARCH ) || 
		( eActivity == ACT_ICEDOG_BARK ) || 
	...
	if ( eActivity == ACT_ICEDOG_CHARGE_START )
		return 12.0f; //4

	// Allow a better turning rate when moving quickly but not charging the player
	if ( ( eActivity == ACT_ICEDOG_CHARGE_RUN ) && IsCurSchedule( SCHED_ICEDOG_CHARGE ) == false )
		return 16.0f;

	// Turn more slowly as we close in on our target
	if ( eActivity == ACT_ICEDOG_CHARGE_RUN )
	{
		if ( pEnemy == NULL )
			return 9.0f; //2
	...
	if ( eActivity == ACT_ICEDOG_CHARGE_STOP )
		return 8.0f;
...
// Output : Returns true on success, false on failure.
//-----------------------------------------------------------------------------
bool CNPC_Icedog::OverrideMove( float flInterval )
{
...
void CNPC_Icedog::Shove( void )
{
	...
	float damage = ( pTarget->IsPlayer() ) ? sk_icedog_dmg_shove.GetFloat() : 250;
	...
	if ( flDistSqr < (ICEDOG_MELEE1_RANGE*ICEDOG_MELEE1_RANGE) && flDot >= ICEDOG_MELEE1_CONE )
	{
		vecEnd = pTarget->WorldSpaceCenter();
	}
	else
	{
		vecEnd = WorldSpaceCenter() + ( BodyDirection3D() * ICEDOG_MELEE1_RANGE );
	}
	...
	if ( pHurt )
	{
		...
		if ( pHurt->IsPlayer() )
		{
			...
			pHurt->ApplyAbsVelocityImpulse( forward * 180 + up * 80 ); //400 150
...
public:
	...
	CTraceFilterCharge( const IHandleEntity *passentity, int collisionGroup, CNPC_Icedog *pAttacker )
	...
	virtual bool ShouldHitEntity( IHandleEntity *pHandleEntity, int contentsMask )
	{
		...
		if ( pEntity )
		{
			...
			float	flDamage = ( pEntity->IsPlayer() ) ? sk_icedog_dmg_shove.GetFloat() : 250;//;
...
//-----------------------------------------------------------------------------
void CNPC_Icedog::Footstep( bool bHeavy )
{
	...
	if ( bHeavy )
	{
		...
		//EmitSound( "NPC_AntlionGuard.StepHeavy" );
	}
	else
	{
		if ( flNearVolume > 0.0f )
...
//			*pOut - 
//-----------------------------------------------------------------------------
void CNPC_Icedog::GetPhysicsShoveDir( CBaseEntity *pObject, float flMass, Vector *pOut )
{
...
// Input  : *pEvent - 
//-----------------------------------------------------------------------------
void CNPC_Icedog::HandleAnimEvent( animevent_t *pEvent )
{
	...
	if ( pEvent->event == AE_ICEDOG_FOOTPRINT_LEFT )
	{
		SnowFootPrint( true );
	}
	if ( pEvent->event == AE_ICEDOG_FOOTPRINT_RIGHT )
	{
		SnowFootPrint( false );
	}
	if ( pEvent->event == AE_ICEDOG_FOOTPRINT_BACK )
	{
		SnowFootPrint();
	}

	if ( pEvent->event == AE_ICEDOG_SHOVE_PHYSOBJECT )
	{
		if ( m_hPhysicsTarget == NULL )
		{
		...
		ClearCondition( COND_ICEDOG_PHYSICS_TARGET );
		ClearCondition( COND_ICEDOG_PHYSICS_TARGET_INVALID );
		...
		if ( GetSquad() != NULL )
		{
			GetSquad()->BroadcastInteraction( g_interactionIcedogShovedPhysicsObject, (void *)((CBaseEntity *)m_hPhysicsTarget), this );
		}
	...
	if ( pEvent->event == AE_ICEDOG_CHARGE_HIT )
	{
	...
	if ( pEvent->event == AE_ICEDOG_SHOVE )
	{
	...
	if ( pEvent->event == AE_ICEDOG_FOOTSTEP_LIGHT )
	{
		if ( HasSpawnFlags(SF_ICEDOG_INSIDE_FOOTSTEPS) )
		{
#if HL2_EPISODIC
	...
	if ( pEvent->event == AE_ICEDOG_FOOTSTEP_HEAVY )
	{
		if ( HasSpawnFlags(SF_ICEDOG_INSIDE_FOOTSTEPS) )
		{
#if HL2_EPISODIC
	...
	if ( pEvent->event == AE_ICEDOG_VOICE_GROWL )
	{
		StartSounds();
		...
		{
			duration = ENVELOPE_CONTROLLER.SoundPlayEnvelope( m_pGrowlHighSound, SOUNDCTRL_CHANGE_VOLUME, envIcedogFastGrowl, ARRAYSIZE(envIcedogFastGrowl) );
		}
		else
		{
			duration = 1.0f;
	...
	if ( pEvent->event == AE_ICEDOG_VOICE_BARK )
	{
		StartSounds();

		float duration = ENVELOPE_CONTROLLER.SoundPlayEnvelope( m_pGrowlHighSound, SOUNDCTRL_CHANGE_VOLUME, envIcedogBark1, ARRAYSIZE(envIcedogBark1) );
		ENVELOPE_CONTROLLER.SoundPlayEnvelope( m_pConfusedSound, SOUNDCTRL_CHANGE_VOLUME, envIcedogBark2, ARRAYSIZE(envIcedogBark2) );
	...
	if ( pEvent->event == AE_ICEDOG_VOICE_ROAR )
	{
		StartSounds();

		float duration = ENVELOPE_CONTROLLER.SoundPlayEnvelope( m_pGrowlHighSound, SOUNDCTRL_CHANGE_VOLUME, envIcedogFastGrowl, ARRAYSIZE(envIcedogFastGrowl) );
	...
	if ( pEvent->event == AE_ICEDOG_VOICE_PAIN )
	{
		StartSounds();

		float duration = ENVELOPE_CONTROLLER.SoundPlayEnvelope( m_pConfusedSound, SOUNDCTRL_CHANGE_VOLUME, envIcedogPain1, ARRAYSIZE(envIcedogPain1) );
		ENVELOPE_CONTROLLER.SoundPlayEnvelope( m_pGrowlHighSound, SOUNDCTRL_CHANGE_VOLUME, envIcedogBark2, ARRAYSIZE(envIcedogBark2) );
	...
	if ( pEvent->event == AE_ICEDOG_VOICE_SQUEEZE )
	{	
		StartSounds();

		float duration = ENVELOPE_CONTROLLER.SoundPlayEnvelope( m_pGrowlHighSound, SOUNDCTRL_CHANGE_VOLUME, envIcedogSqueeze, ARRAYSIZE(envIcedogSqueeze) );
	...
	if ( pEvent->event == AE_ICEDOG_VOICE_SCRATCH )
	{	
		StartSounds();
	...
	if ( pEvent->event == AE_ICEDOG_VOICE_GRUNT )
	{	
		StartSounds();

		float duration = ENVELOPE_CONTROLLER.SoundPlayEnvelope( m_pConfusedSound, SOUNDCTRL_CHANGE_VOLUME, envIcedogGrunt, ARRAYSIZE(envIcedogGrunt) );
		ENVELOPE_CONTROLLER.SoundPlayEnvelope( m_pGrowlHighSound, SOUNDCTRL_CHANGE_VOLUME, envIcedogGrunt2, ARRAYSIZE(envIcedogGrunt2) );
...
// Purpose: 
//-----------------------------------------------------------------------------
void CNPC_Icedog::SetHeavyDamageAnim( const Vector &vecSource )
{
	...
	if ( damageDot > 0.0f )
	{
		...
		{
			m_nFlinchActivity = ACT_ICEDOG_PHYSHIT_FR;
		}
		else
		{
			m_nFlinchActivity = ACT_ICEDOG_PHYSHIT_FL;
		}
	}
	else
	{
		...
		if ( damageRightDot < 0.0f )
		{
			m_nFlinchActivity = ACT_ICEDOG_PHYSHIT_RR;
		}
		else
		{
			m_nFlinchActivity = ACT_ICEDOG_PHYSHIT_RL;
		}
	}
}
...
// Input  : &info - 
//-----------------------------------------------------------------------------
int CNPC_Icedog::OnTakeDamage_Alive( const CTakeDamageInfo &info )
{
	CTakeDamageInfo dInfo = info;

	// Don't take damage from another antlion guard!
	if ( dInfo.GetAttacker() && dInfo.GetAttacker() != this && FClassnameIs( dInfo.GetAttacker(), "npc_icedog" ) )
		return 0;
...
//			bitsDamageType - 
//-----------------------------------------------------------------------------
void CNPC_Icedog::TraceAttack( const CTakeDamageInfo &inputInfo, const Vector &vecDir, trace_t *ptr )
{
...
// Input  : *pTask - 
//-----------------------------------------------------------------------------
void CNPC_Icedog::StartTask( const Task_t *pTask )
{
	switch ( pTask->iTask )
	{
	case TASK_ICEDOG_SET_FLINCH_ACTIVITY:
		SetIdealActivity( (Activity) m_nFlinchActivity );
		break;

	case TASK_ICEDOG_SHOVE_PHYSOBJECT:
		{
			...
			SetActivity( ACT_ICEDOG_SHOVE_PHYSOBJECT );
		}
		break;

	case TASK_ICEDOG_FIND_PHYSOBJECT:
		{
	...
	case TASK_ICEDOG_GET_PATH_TO_PHYSOBJECT:
		{
			if ( ( m_hPhysicsTarget == NULL ) || ( GetEnemy() == NULL ) )
			{
	...
	case TASK_ICEDOG_GET_PATH_TO_NEAREST_NODE:
		{
			if ( !GetEnemy() )
			{
	...
	case TASK_ICEDOG_GET_CHASE_PATH_ENEMY_TOLERANCE:
		{
...
//-----------------------------------------------------------------------------
void ApplyDogChargeDamage( CBaseEntity *pIcedog, CBaseEntity *pTarget, float flDamage )
{
	Vector attackDir = ( pTarget->WorldSpaceCenter() - pIcedog->WorldSpaceCenter() );
	VectorNormalize( attackDir );
	...
	// Deal the damage
	CTakeDamageInfo	info( pIcedog, pIcedog, vecForce, offset, flDamage, DMG_CLUB );
...
// Output : Returns true on success, false on failure.
//-----------------------------------------------------------------------------
bool CNPC_Icedog::EnemyIsRightInFrontOfMe( CBaseEntity **pEntity )
{
	if ( !GetEnemy() )
		return false;
...
//-----------------------------------------------------------------------------
void CNPC_Icedog::ChargeLookAhead( void )
{
	trace_t	tr;
	Vector vecForward;
	...
	if ( tr.fraction != 1.0 )
	{
		...
		AddGesture( ACT_ICEDOG_CHARGE_ANTICIPATION );
	}
}
...
//-----------------------------------------------------------------------------
bool CNPC_Icedog::HandleChargeImpact( Vector vecImpact, CBaseEntity *pEntity )
{
	...
	if ( IRelationType( pEntity ) == D_HT && ( GetNextAttack() < gpGlobals->curtime ) )
	{
		...
		if ( !IsPlayingGesture( ACT_ICEDOG_CHARGE_HIT ) )
		{
			RestartGesture( ACT_ICEDOG_CHARGE_HIT );
		}
		...
		SetActivity( ACT_ICEDOG_CHARGE_STOP );
...
// Output : float
//-----------------------------------------------------------------------------
float CNPC_Icedog::ChargeSteer( void )
{
	trace_t	tr;
...
// Input  : *pTask - 
//-----------------------------------------------------------------------------
void CNPC_Icedog::RunTask( const Task_t *pTask )
{
	switch (pTask->iTask)
	{
	case TASK_ICEDOG_SET_FLINCH_ACTIVITY:
	...
	case TASK_ICEDOG_CHARGE:
		{
			...
			if ( eActivity == ACT_ICEDOG_CHARGE_STOP || eActivity == ACT_ICEDOG_CHARGE_CRASH ) 
			{
				if ( IsActivityFinished() )
				{
					TaskComplete();
			...
			if ( ( eActivity == ACT_ICEDOG_CHARGE_START ) && ( IsActivityFinished() ) )
			{
				SetActivity( ACT_ICEDOG_CHARGE_RUN );
			}

			// See if we're still running
			if ( eActivity == ACT_ICEDOG_CHARGE_RUN || eActivity == ACT_ICEDOG_CHARGE_START ) 
			{
			...
			if ( AutoMovement( GetEnemy(), &moveTrace ) == false )
			{
				...
				if ( HandleChargeImpact( moveTrace.vEndPosition, moveTrace.pObstruction ) )
				{
					...
					if ( eActivity != ACT_ICEDOG_CHARGE_STOP )
					{
						...
						{
							SetActivity( ACT_ICEDOG_CHARGE_CRASH );
						}
					}
				}
				else if ( moveTrace.pObstruction )
				{
					...
					{
						if ( FClassnameIs( moveTrace.pObstruction, "npc_icedog" ) )
						{
							// Crash unless we're trying to stop already
							if ( eActivity != ACT_ICEDOG_CHARGE_STOP )
							{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CNPC_Icedog::FoundEnemy( void )
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CNPC_Icedog::LostEnemy( void )
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CNPC_Icedog::InputSetShoveTarget( inputdata_t &inputdata )
{
	if ( IsAlive() == false )
		return;
...
// Purpose: 
//-----------------------------------------------------------------------------
void CNPC_Icedog::InputSetChargeTarget( inputdata_t &inputdata )
{
	if ( !IsAlive() )
		return;
	...
	SetCondition( COND_ICEDOG_HAS_CHARGE_TARGET );
...
// Input  : &inputdata - 
//-----------------------------------------------------------------------------
void CNPC_Icedog::InputClearChargeTarget( inputdata_t &inputdata )
{
	m_hChargeTarget = NULL;
}
...
// Output : Activity
//-----------------------------------------------------------------------------
Activity CNPC_Icedog::NPC_TranslateActivity( Activity baseAct )
{
	//See which run to use
	if ( ( baseAct == ACT_RUN ) && IsCurSchedule( SCHED_ICEDOG_CHARGE ) )
		return (Activity) ACT_ICEDOG_CHARGE_RUN;

	if ( ( baseAct == ACT_RUN ) && ( m_iHealth <= (m_iMaxHealth/4) ) )
		return (Activity) ACT_ICEDOG_RUN_HURT;
...
// Output : Returns true on success, false on failure.
//-----------------------------------------------------------------------------
bool CNPC_Icedog::ShouldWatchEnemy( void )
{
	Activity nActivity = GetActivity();

	if ( ( nActivity == ACT_ICEDOG_SEARCH ) || 
		 ( nActivity == ACT_ICEDOG_SHOVE_PHYSOBJECT ) || 
		 ( nActivity == ACT_ICEDOG_PHYSHIT_FR ) || 
		 ( nActivity == ACT_ICEDOG_PHYSHIT_FL ) || 
		 ( nActivity == ACT_ICEDOG_PHYSHIT_RR ) || 
		 ( nActivity == ACT_ICEDOG_PHYSHIT_RL ) || 
		 ( nActivity == ACT_ICEDOG_CHARGE_CRASH ) || 
		 ( nActivity == ACT_ICEDOG_CHARGE_HIT ) ||
		 ( nActivity == ACT_ICEDOG_CHARGE_ANTICIPATION ) )
	{
		return false;
	}
...
// Purpose: 
//-----------------------------------------------------------------------------
void CNPC_Icedog::UpdateHead( void )
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CNPC_Icedog::MaintainPhysicsTarget( void )
{
	if ( m_hPhysicsTarget == NULL || GetEnemy() == NULL )
		return;
	...
	{
		ClearCondition( COND_ICEDOG_PHYSICS_TARGET );
		SetCondition( COND_ICEDOG_PHYSICS_TARGET_INVALID );
		m_hPhysicsTarget = NULL;
		return;
	}
	else
...
// Purpose: 
//-----------------------------------------------------------------------------
void CNPC_Icedog::UpdatePhysicsTarget( bool bPreferObjectsAlongTargetVector, float flRadius )
{
	if ( GetEnemy() == NULL )
		return;
	...
	criteria.flTargetCone = ICEDOG_OBJECTFINDING_FOV;
...
//-----------------------------------------------------------------------------
bool CNPC_Icedog::ShouldProbeCollideAgainstEntity( CBaseEntity *pEntity )
{
	...
	if ( pEntity->GetMoveType() == MOVETYPE_VPHYSICS )
	{
		...
		if( pPhysObj && pPhysObj->GetMass() <= ICEDOG_MAX_OBJECT_MASS )
		{
			return false;
		}
	}
...
// Purpose: 
//-----------------------------------------------------------------------------
void CNPC_Icedog::PrescheduleThink( void )
{
	...
	if ( IsCurSchedule( SCHED_ICEDOG_CHASE_ENEMY ) || 
		 IsCurSchedule( SCHED_ICEDOG_PATROL_RUN ) ||
		 IsCurSchedule( SCHED_ICEDOG_CANT_ATTACK ) ||
		 IsCurSchedule( SCHED_ICEDOG_CHASE_ENEMY_TOLERANCE ) )
	{
		bool bCheckAlongLine = ( IsCurSchedule( SCHED_ICEDOG_CHASE_ENEMY ) || IsCurSchedule( SCHED_ICEDOG_CHASE_ENEMY_TOLERANCE ) );
		UpdatePhysicsTarget( bCheckAlongLine );
	}
	else if ( !IsCurSchedule( SCHED_ICEDOG_PHYSICS_ATTACK ) )
	{
		ClearCondition( COND_ICEDOG_PHYSICS_TARGET );
		m_hPhysicsTarget = NULL;
	}
...
// Purpose: 
//-----------------------------------------------------------------------------
void CNPC_Icedog::GatherConditions( void )
{
	...
	if( IsCurSchedule(SCHED_ICEDOG_PHYSICS_ATTACK) )
	{
	...
	if ( GetEnemy() )
	{
		...
		{
			SetCondition( COND_ICEDOG_CAN_CHARGE );
		}
		else
		{
			ClearCondition( COND_ICEDOG_CAN_CHARGE );
		}
	}
}
...
// Purpose: 
//-----------------------------------------------------------------------------
void CNPC_Icedog::StopLoopingSounds()
{
	//Stop all sounds
...
// Output  :
//------------------------------------------------------------------------------
bool CNPC_Icedog::IsUnreachable(CBaseEntity *pEntity)
{
...
//-----------------------------------------------------------------------------
Vector CNPC_Icedog::GetPhysicsHitPosition( CBaseEntity *pObject, CBaseEntity *pTarget, Vector *vecTrajectory, float *flClearDistance )
{
...
// Output : Returns true on success, false on failure.
//-----------------------------------------------------------------------------
inline bool CNPC_Icedog::CanStandAtPoint( const Vector &vecPos, Vector *pOut )
{
...
//-----------------------------------------------------------------------------
bool CNPC_Icedog::CanStandAtShoveTarget( CBaseEntity *pShoveObject, CBaseEntity *pTarget, Vector *pOut )
{
...
//-----------------------------------------------------------------------------
CBaseEntity *CNPC_Icedog::GetNextShoveTarget( CBaseEntity *pLastEntity, AISightIter_t &iter )
{
...
//-----------------------------------------------------------------------------
CBaseEntity *CNPC_Icedog::FindPhysicsObjectTarget( const PhysicsObjectCriteria_t &criteria )
{
...
//-----------------------------------------------------------------------------
void CNPC_Icedog::BuildScheduleTestBits( void )
{
	...
	if ( IsCurSchedule( SCHED_ICEDOG_CHASE_ENEMY ) )
	{
		SetCustomInterruptCondition( COND_ICEDOG_PHYSICS_TARGET );
	}

	// Interrupt if we've been given a charge target
	if ( IsCurSchedule( SCHED_ICEDOG_CHARGE ) == false )
	{
		SetCustomInterruptCondition( COND_ICEDOG_HAS_CHARGE_TARGET );
	}
...
//			magnitude - 
//-----------------------------------------------------------------------------
void CNPC_Icedog::ImpactShock( const Vector &origin, float radius, float magnitude, CBaseEntity *pIgnored )
{
...
// Input  : *pTarget - 
//-----------------------------------------------------------------------------
void CNPC_Icedog::ChargeDamage( CBaseEntity *pTarget )
{
	if ( pTarget == NULL )
		return;
	...
	float flDamage = 0;
	flDamage = ( pPlayer == NULL ) ? 250 : sk_icedog_dmg_charge.GetFloat();
...
// Input  : &inputdata - 
//-----------------------------------------------------------------------------
void CNPC_Icedog::InputRagdoll( inputdata_t &inputdata )
{
	if ( IsAlive() == false )
		return;
...
//-----------------------------------------------------------------------------
void CNPC_Icedog::InputEnablePreferPhysicsAttack( inputdata_t &inputdata )
{
...
//-----------------------------------------------------------------------------
void CNPC_Icedog::InputDisablePreferPhysicsAttack( inputdata_t &inputdata )
{
...
// Purpose: 
//-----------------------------------------------------------------------------
int CNPC_Icedog::SelectFailSchedule( int failedSchedule, int failedTask, AI_TaskFailureCode_t taskFailCode )
{
	// Figure out what to do next
	if ( failedSchedule == SCHED_ICEDOG_CHASE_ENEMY && HasCondition( COND_ENEMY_UNREACHABLE ) )
		return SelectUnreachableSchedule();
...
// Output : int
//-----------------------------------------------------------------------------
int CNPC_Icedog::TranslateSchedule( int scheduleType )
{
	switch( scheduleType )
	{
	case SCHED_CHASE_ENEMY:
		return SCHED_ICEDOG_CHASE_ENEMY;
		break;
	}
...
// Purpose: 
//-----------------------------------------------------------------------------
void CNPC_Icedog::StartSounds( void )
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CNPC_Icedog::InputEnableBark( inputdata_t &inputdata )
{
	m_bBarkEnabled = true;
}
...
// Purpose: 
//-----------------------------------------------------------------------------
void CNPC_Icedog::InputDisableBark( inputdata_t &inputdata )
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CNPC_Icedog::DeathSound( const CTakeDamageInfo &info )
{
...
// Input  : &info - 
//-----------------------------------------------------------------------------
void CNPC_Icedog::Event_Killed( const CTakeDamageInfo &info )
{
...
// Output : Returns true on success, false on failure.
//-----------------------------------------------------------------------------
bool CNPC_Icedog::CanBecomeRagdoll( void )
{
...
// Output : Returns true on success, false on failure.
//-----------------------------------------------------------------------------
bool CNPC_Icedog::BecomeRagdollOnClient( const Vector &force )
{
	if ( !CanBecomeRagdoll() ) 
		return false;
	...
	if ( m_spawnflags & SF_ICEDOG_SERVERSIDE_RAGDOLL )
	{
...
// Output :
//-----------------------------------------------------------------------------
bool CNPC_Icedog::OverrideMoveFacing( const AILocalMoveGoal_t &move, float flInterval )
{
...
#ifdef HL2_EPISODIC
	else if ( GetEnemy() && IsCurSchedule( SCHED_ICEDOG_CANT_ATTACK ) )
	{
	...
	else if ( GetEnemy() && GetNavigator()->GetMovementActivity() == ACT_RUN )
  	{
		...
		if ( ( UTIL_DistApprox( vecEnemyLKP, GetAbsOrigin() ) < 512 ) || IsCurSchedule( SCHED_ICEDOG_PATROL_RUN ) )
		{
...
// Output : Returns true on success, false on failure.
//-----------------------------------------------------------------------------
bool CNPC_Icedog::IsHeavyDamage( const CTakeDamageInfo &info )
{
	// Struck by blast
...
// Output : Returns true on success, false on failure.
//-----------------------------------------------------------------------------
bool CNPC_Icedog::IsLightDamage( const CTakeDamageInfo &info )
{
	return false;
}
...
// Output : Returns true on success, false on failure.
//-----------------------------------------------------------------------------
bool CNPC_Icedog::QueryHearSound( CSound *pSound )
{
...
//---------------------------------------------------------
bool CNPC_Icedog::CNavigator::GetStoppingPath( CAI_WaypointList *pClippedWaypoints )
{
...
// Output : Returns true on success, false on failure.
//-----------------------------------------------------------------------------
bool CNPC_Icedog::RememberFailedPhysicsTarget( CBaseEntity *pTarget )
{
	// Already in the list?
...
// Output : Returns true on success, false on failure.
//-----------------------------------------------------------------------------
bool CNPC_Icedog::HandleInteraction( int interactionType, void *data, CBaseCombatCharacter *sender )
{
	// Don't chase targets that other guards in our squad may be going after!
	if ( interactionType == g_interactionIcedogFoundPhysicsObject )
	{
	...
	if ( interactionType == g_interactionIcedogShovedPhysicsObject )
	{
...
// Output :
//-----------------------------------------------------------------------------
void CNPC_Icedog::SnowFootPrint()
{
	trace_t tr;
	Vector traceStart;
	QAngle angles;
...
// Output :
//-----------------------------------------------------------------------------
void CNPC_Icedog::SnowFootPrint( bool IsLeft )
{
	trace_t tr;
	Vector traceStart;
	QAngle angles;
...
//-----------------------------------------------------------------------------
void	CNPC_Icedog::PopulatePoseParameters( void )
{
...
//-----------------------------------------------------------------------------
unsigned char CNPC_Icedog::GetBleedingLevel( void ) const
{
...
AI_BEGIN_CUSTOM_NPC( npc_icedog, CNPC_Icedog )

	// Interactions	
	DECLARE_INTERACTION( g_interactionIcedogFoundPhysicsObject )
	DECLARE_INTERACTION( g_interactionIcedogShovedPhysicsObject )

	// Squadslots	
	DECLARE_SQUADSLOT( SQUAD_SLOT_ICEDOG_CHARGE )

	//Tasks
	DECLARE_TASK( TASK_ICEDOG_CHARGE )
	DECLARE_TASK( TASK_ICEDOG_GET_PATH_TO_PHYSOBJECT )
	DECLARE_TASK( TASK_ICEDOG_SHOVE_PHYSOBJECT )
	DECLARE_TASK( TASK_ICEDOG_SET_FLINCH_ACTIVITY )
	DECLARE_TASK( TASK_ICEDOG_GET_PATH_TO_CHARGE_POSITION )
	DECLARE_TASK( TASK_ICEDOG_GET_PATH_TO_NEAREST_NODE )
	DECLARE_TASK( TASK_ICEDOG_GET_CHASE_PATH_ENEMY_TOLERANCE )
	//DECLARE_TASK( TASK_ICEDOG_OPPORTUNITY_THROW )
	DECLARE_TASK( TASK_ICEDOG_FIND_PHYSOBJECT )

	//Activities
	DECLARE_ACTIVITY( ACT_ICEDOG_SEARCH )
	DECLARE_ACTIVITY( ACT_ICEDOG_BARK )
	DECLARE_ACTIVITY( ACT_ICEDOG_CHARGE_START )
	DECLARE_ACTIVITY( ACT_ICEDOG_CHARGE_CANCEL )
	DECLARE_ACTIVITY( ACT_ICEDOG_CHARGE_RUN )
	DECLARE_ACTIVITY( ACT_ICEDOG_CHARGE_CRASH )
	DECLARE_ACTIVITY( ACT_ICEDOG_CHARGE_STOP )
	DECLARE_ACTIVITY( ACT_ICEDOG_CHARGE_HIT )
	DECLARE_ACTIVITY( ACT_ICEDOG_CHARGE_ANTICIPATION )
	DECLARE_ACTIVITY( ACT_ICEDOG_SHOVE_PHYSOBJECT )
	DECLARE_ACTIVITY( ACT_ICEDOG_FLINCH_LIGHT )
	DECLARE_ACTIVITY( ACT_ICEDOG_ROAR )
	DECLARE_ACTIVITY( ACT_ICEDOG_PHYSHIT_FR )
	DECLARE_ACTIVITY( ACT_ICEDOG_PHYSHIT_FL )
	DECLARE_ACTIVITY( ACT_ICEDOG_PHYSHIT_RR )	
	DECLARE_ACTIVITY( ACT_ICEDOG_PHYSHIT_RL )		
	
	//Adrian: events go here
	DECLARE_ANIMEVENT( AE_ICEDOG_CHARGE_HIT )
	DECLARE_ANIMEVENT( AE_ICEDOG_SHOVE_PHYSOBJECT )
	DECLARE_ANIMEVENT( AE_ICEDOG_SHOVE )
	DECLARE_ANIMEVENT( AE_ICEDOG_FOOTSTEP_LIGHT )
	DECLARE_ANIMEVENT( AE_ICEDOG_FOOTSTEP_HEAVY )
	DECLARE_ANIMEVENT( AE_ICEDOG_VOICE_GROWL )
	DECLARE_ANIMEVENT( AE_ICEDOG_VOICE_BARK )
	DECLARE_ANIMEVENT( AE_ICEDOG_VOICE_PAIN )
	DECLARE_ANIMEVENT( AE_ICEDOG_VOICE_SQUEEZE )
	DECLARE_ANIMEVENT( AE_ICEDOG_VOICE_SCRATCH )
	DECLARE_ANIMEVENT( AE_ICEDOG_VOICE_GRUNT )
	DECLARE_ANIMEVENT( AE_ICEDOG_VOICE_ROAR )
	DECLARE_ANIMEVENT( AE_ICEDOG_FOOTPRINT_LEFT )
	DECLARE_ANIMEVENT( AE_ICEDOG_FOOTPRINT_RIGHT )
	DECLARE_ANIMEVENT( AE_ICEDOG_FOOTPRINT_BACK )

	DECLARE_CONDITION( COND_ICEDOG_PHYSICS_TARGET )
	DECLARE_CONDITION( COND_ICEDOG_PHYSICS_TARGET_INVALID )
	DECLARE_CONDITION( COND_ICEDOG_HAS_CHARGE_TARGET )
	DECLARE_CONDITION( COND_ICEDOG_CAN_CHARGE )
	...
	(
		...
		"	Tasks"
		"		TASK_STOP_MOVING					0"
		"		TASK_SET_FAIL_SCHEDULE				SCHEDULE:SCHED_ICEDOG_CHASE_ENEMY"
		"		TASK_FACE_ENEMY						0"
		"		TASK_ICEDOG_CHARGE			0"
		""
		"	Interrupts"
		"		COND_TASK_FAILED"
		"		COND_HEAVY_DAMAGE"
	...
	(
		...
		"	Tasks"
		"		TASK_STOP_MOVING			0"
		"		TASK_PLAY_SEQUENCE			ACTIVITY:ACT_ICEDOG_CHARGE_CRASH"
		""
		"	Interrupts"
		"		COND_TASK_FAILED"
		"		COND_HEAVY_DAMAGE"
	...
	( 
		...
		"	Tasks"
		"		TASK_SET_FAIL_SCHEDULE						SCHEDULE:SCHED_ICEDOG_CHASE_ENEMY"
		"		TASK_ICEDOG_GET_PATH_TO_PHYSOBJECT	0"
		"		TASK_RUN_PATH								0"
		"		TASK_WAIT_FOR_MOVEMENT						0"
		"		TASK_FACE_ENEMY								0"
		"		TASK_ICEDOG_SHOVE_PHYSOBJECT			0"
		""
		"	Interrupts"
		"		COND_TASK_FAILED"
		"		COND_ENEMY_DEAD"
	...
	( 
		...
		"	Tasks"
		"		TASK_SET_FAIL_SCHEDULE						SCHEDULE:SCHED_ICEDOG_CANT_ATTACK"
		"		TASK_ICEDOG_FIND_PHYSOBJECT			0"
		"		TASK_SET_SCHEDULE							SCHEDULE:SCHED_ICEDOG_PHYSICS_ATTACK"
		""
		"	Interrupts"
		"		COND_ICEDOG_PHYSICS_TARGET"
		"		COND_HEAVY_DAMAGE"
	)
	...
	(
		...
		"		TASK_ICEDOG_SET_FLINCH_ACTIVITY	0"
		""
		"	Interrupts"
	)
	...
	(
		...
		"	Tasks"
		"		TASK_PLAY_SEQUENCE			ACTIVITY:ACT_ICEDOG_CHARGE_CANCEL"
		""
		"	Interrupts"
	)
	...
	(
		...
		"	Tasks"
		"		TASK_ICEDOG_GET_PATH_TO_CHARGE_POSITION	0"
		"		TASK_RUN_PATH									0"
		"		TASK_WAIT_FOR_MOVEMENT							0"
		"	"
		"	Interrupts"
	...
	(
		...
		"	Tasks"
		"		TASK_STOP_MOVING									0"
		"		TASK_SET_FAIL_SCHEDULE								SCHEDULE:SCHED_ICEDOG_PATROL_RUN"
		"		TASK_ICEDOG_GET_PATH_TO_NEAREST_NODE			2400" //500
		"		TASK_RUN_PATH										0"
		"		TASK_WAIT_FOR_MOVEMENT								0"
		"		TASK_FACE_ENEMY										0"
		""
	...
	(
		...
		"		TASK_STOP_MOVING			0"
		"		TASK_FACE_ENEMY				0"
		"		TASK_PLAY_SEQUENCE			ACTIVITY:ACT_ICEDOG_ROAR"
		"	"
		"	Interrupts"
		"		COND_HEAVY_DAMAGE"
	)
