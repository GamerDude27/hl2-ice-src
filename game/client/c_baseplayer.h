...
public:
	...
	// ICEMOD
	bool			IsHelmetEquipped( void ) { return m_Local.m_bWearingHelmet; };
	// Helmet Effects
	int				GetHelmetDamageAlpha( void ){ return m_Local.m_iHelmetDamageAlpha; }; // <-- do you need these at end of line here? ";" JASON
	int				GetHelmetBloodAlpha( void ){ return m_Local.m_iHelmetBloodAlpha; }; // <-- do you need these at end of line here? ";" JASON
	int				GetHelmetBloodColor( void ){ return m_Local.m_iHelmetBloodColor; }; // <-- do you need these at end of line here? ";" JASON
	void			SetHelmetBloodColor(int newColor ) 
	{ 
		if(newColor >= 2 ) 
	...
	{ 
		if((m_Local.m_iHelmetBloodAlpha + BldAlpha) < 255)
			m_Local.m_iHelmetBloodAlpha++;
		Msg("c_baseplayer.h called it");
	};
