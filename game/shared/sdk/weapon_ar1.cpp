...
//			nDamageType - 
//-----------------------------------------------------------------------------
void CWeaponAR1::DoImpactEffect( trace_t &tr, int nDamageType )
{
	CEffectData data;
...
// Purpose: 
//-----------------------------------------------------------------------------
void CWeaponAR1::DelayedAttack( void )
{
...
//-----------------------------------------------------------------------------
bool CWeaponAR1::CanHolster( void )
{
	if ( m_bShotDelayed )
		return false;
...
// Purpose: 
//-----------------------------------------------------------------------------
void CWeaponAR1::FireNPCSecondaryAttack( CBaseCombatCharacter *pOperator, bool bUseWeaponAngles )
{
	WeaponSound( WPN_DOUBLE );
