...
BEGIN_SEND_TABLE_NOBASE( CPlayerLocalData, DT_Local )
	...
	SendPropInt		(SENDINFO(m_bWearingHelmet), 1, SPROP_UNSIGNED ),
	SendPropInt		(SENDINFO(m_iHelmetDamageAlpha), 1, SPROP_UNSIGNED ),
	SendPropInt		(SENDINFO(m_iHelmetBloodAlpha), 1, SPROP_UNSIGNED ),
	SendPropInt		(SENDINFO(m_iHelmetBloodColor), 1, SPROP_UNSIGNED ),
...
BEGIN_SIMPLE_DATADESC( CPlayerLocalData )
	...
	DEFINE_FIELD( m_bWearingHelmet, FIELD_BOOLEAN ),
	DEFINE_FIELD( m_iHelmetDamageAlpha, FIELD_INTEGER ),
	DEFINE_FIELD( m_iHelmetBloodAlpha, FIELD_INTEGER ),
	DEFINE_FIELD( m_iHelmetBloodColor, FIELD_INTEGER ),
