...
//
// Purpose: Defines the chumtoad, a tiny, jumpy alien parasite.
//
//=============================================================================//

#ifndef NPC_CHUMTOAD_H
#define NPC_CHUMTOAD_H
#ifdef _WIN32
#pragma once
#endif
...
abstract_class CBaseChumtoad : public CAI_BaseNPC
{
	DECLARE_CLASS( CBaseChumtoad, CAI_BaseNPC );
...
//=========================================================
//=========================================================
// The ever popular chubby classic chumtoad
//=========================================================
//=========================================================
class CChumtoad : public CBaseChumtoad
{
	DECLARE_CLASS( CChumtoad, CBaseChumtoad );
