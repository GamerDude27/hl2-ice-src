...
public:
	...
	// Is the player wearing the HEV suit or helmet
	CNetworkVar( bool, m_bWearingSuit );
	// ICEMOD
	CNetworkVar( bool, m_bWearingHelmet );
	CNetworkVar( int, m_iHelmetDamageAlpha );
	CNetworkVar( int, m_iHelmetBloodAlpha );
	CNetworkVar( int, m_iHelmetBloodColor );
